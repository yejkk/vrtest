...
//import com.vrplayer.test.vrplayertest.util.Utils;
//import com.vrplayer.test.vrplayertest.util.VideoController;
//
///**
// * Created by userd on 2017/9/12.
// */
//
//public class PlayActivity extends Activity implements UVPlayerCallBack, VideoController.PlayerControl{
...
//    private String Path = "http://192.168.17.179/resource/L3_yjznd36ikoeiral1.utovr";
...
//        mMediaplayer = new UVMediaPlayer(PlayActivity.this, rlPlayView);
...
//        {
//            mMediaplayer.onResume(PlayActivity.this);
//        }
//    }
//
//    @Override
...
//        {
//            Toast.makeText(PlayActivity.this, Utils.getErrMsg(ErrType), Toast.LENGTH_SHORT).show();
//        }
//
//        @Override
