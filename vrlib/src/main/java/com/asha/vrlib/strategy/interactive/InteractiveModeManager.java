...
public class InteractiveModeManager extends ModeManager<AbsInteractiveStrategy> implements IInteractiveMode {
    ...
    protected AbsInteractiveStrategy createStrategy(int mode) {
        switch (mode){
            ...
            case MDVRLibrary.INTERACTIVE_MODE_KEYDOWN:
                return new KeyStrategy(mParams);
            case MDVRLibrary.INTERACTIVE_MODE_MOBILECONTROL:
                return new MobileMotionStrategy(mParams);
